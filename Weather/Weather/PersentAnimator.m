...
@implementation PersentAnimator

+ (PersentAnimator *)shared {
    static PersentAnimator *shared = nil;
...
- (void)handlePopRecognizer:(UIScreenEdgePanGestureRecognizer *)gestureRecognizer {
    ...
    switch (gestureRecognizer.state) {
        ...
        case UIGestureRecognizerStateChanged: {
            ...
            CGFloat fraction = translation.x / [[[UIApplication sharedApplication] delegate] window].width;
